    ...
    <div className='flex flex-col w-[400px] max-md:w-[90%] overflow-y-scroll scrollbar-hide'>
      ...
      {selectedPlaylistId && (
        <>
          ...
          <p className='w-full p-2 bg-slate-600 text-lg text-white font-semibold rounded-md'>{playlistName}</p>
          <h2 className='text-xl text-textcolor font-semibold mt-5 mb-2'>Playlist ID:</h2>
          <p className='w-full p-2 bg-slate-600 text-lg text-white font-semibold rounded-md'>{playlistId}</p>
