...
//         const nonFollowedForeignMaleArtists = allArtists.filter(
//           artist => !followedArtistIds.has(artist.artistId) && artist.artistType === 'foreign_male'
//         );

//         setArtists(allArtists);
//         setFilteredArtists(nonFollowedForeignMaleArtists);
//       } catch (error) {
