...
const IndianFemale = ({setArtistId}) => {
  ...
  useEffect(() => {
    const fetchArtists = async () => {
      try {
        ...
        const nonFollowedIndianFemaleArtists = allArtists.filter(
          artist => !followedArtistIds.has(artist.artistId) && artist.artistType === 'indian_female'
        );

        setArtists(allArtists);
        setFilteredArtists(nonFollowedIndianFemaleArtists);
      } catch (error) {
