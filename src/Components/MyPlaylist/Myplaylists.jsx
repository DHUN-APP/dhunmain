...
//             // Fetch 'myplaylists' directly from user document
//             if (Array.isArray(userData.myplaylists)) {
//               combinedPlaylists = [...userData.myplaylists];
//             } else {
//               console.error('myplaylists data is not an array');
//             }

//             // Fetch 'playlists' by querying the 'playlists' collection using IDs from user's 'playlists' array
...
//               const fetchedPlaylists = playlistsSnapshot.docs.map(doc => doc.data());
          ...
          if (userDocSnapshot.exists()) {
            ...
            if (Array.isArray(userData.myplaylists)) {
              const myPlaylists = userData.myplaylists.map(playlist => ({
                ...playlist,
                type: 'myplaylist', // Add a type field to distinguish between playlist types
              }));
            ...
            if (Array.isArray(userData.playlists)) {
              ...
              const fetchedPlaylists = playlistsSnapshot.docs.map(doc => ({
                ...doc.data(),
                type: 'externalplaylist', // Add a type field to distinguish between playlist types
              }));
