...
import { useAuth } from "../../Context/AuthContext";
import { db } from "../../../firebase-config";
import { doc, setDoc, getDocs,updateDoc,arrayUnion, collection, increment } from "firebase/firestore";
import { useNavigate } from "react-router-dom";
import UniversalLoader from "../Loaders/UniversalLoader";
import { UisCheckCircle } from "@iconscout/react-unicons-solid";
import { UilArrowRight } from "@iconscout/react-unicons";
...
const SelectPlaylists = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update user's playlists in Firestore
      await setDoc(
        userDocRef,
        {
      ...
      // Update follower count for each selected playlist
